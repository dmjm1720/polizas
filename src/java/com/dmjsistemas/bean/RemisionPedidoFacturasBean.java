...
@Named(value = "remisionPedidoFacturaBean")
@ViewScoped
public class RemisionPedidoFacturasBean extends Conexion implements Serializable {
    ...
    public void init() {
        ...
        this.tmpRutaXF = new TempRuta();
        this.tmpRutaXF.setRutaTemp("/resources/archivoFRPxFactura.pdf");
        lista = new ArrayList<>();
    ...
    public TempRuta getTmpRutaXF() {
        return tmpRutaXF;
    }

    public void setTmpRutaXF(TempRuta tmpRutaXF) {
        this.tmpRutaXF = tmpRutaXF;
    }
    ...
    public void insertarInformacion() throws SQLException, InterruptedException {
        ...
        listaVFR = listaEncabezadosR.obtenerInfoEncabezadosRecepcionXF(factura);
        ...
        for (int i = 0; i < listaVFR.size(); i++) {
            ...
            l = listaFRP.listaFRP(listaVFR.get(i).getCveDoc().trim());
    ...
    public void impresion(List<EncabezadosRecepcion> lista) throws InterruptedException {
        ...
        this.tmpRutaXF.setRutaTemp(pathResources + "/archivoFRPxFactura.pdf");
        String pdfExtension = ".pdf";

        //Borrar archivo previamente generado
        File archivoBorrar = new File(this.tmpRutaXF.getRutaTemp());
        ...
        try {
            ...
            merger.setDestinationFileName(tmpRutaXF.getRutaTemp());
            // Fusionar los PDFs

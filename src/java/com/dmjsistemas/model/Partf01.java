...
public class Partf01 {
    ...
    public Partf01(String tipDoc, String cveDoc, String cveClpv, String status, Date fechaDoc, Date fechaEnt, Date fechaVen, double canTot, double impTot1, double impTot4, long cveObs, long numAlma, String actCxc, String actCoi, String enlazado, String tipDocE, long numMoned, double tipcamb, long numPagos, Date fechaelab, double primerpago, String rfc, long ctlpol, String escfd, long autoriza, String serie, long folio, String autoanio, long datEnvio, String contado, long cveBita, String bloq, String formaenvio, double desFinPorc, double desTotPorc, double importe, double comTotPorc, String tipDocAnt, String docAnt) {
        this.tipDoc = tipDoc;
        this.cveDoc = cveDoc;
